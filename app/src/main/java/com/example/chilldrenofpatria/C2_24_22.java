...
public class C2_24_22 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_22);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_22", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_22);

        String text ="“Dole Kakaw”\n" +
                "The blue bolt strikes the werejackal in the torso. It yelps and shifts its path to avoid you. It doesn’t make it far, as Meytheo appears from one of the trees and smashes its chest with her club. It drops to its knees, spitting up blood, just as she takes another swing, and its head flies back with a snap. \n" +
                "Looking around to check there isn’t any more, you find only dead jackals. You look at Meytheo, who is dragging one of the jackals to the fire pit. She throws it on the fire and walks to the next body.\n" +
