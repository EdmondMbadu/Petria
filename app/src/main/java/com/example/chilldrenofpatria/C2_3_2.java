...
public class C2_3_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_3_2);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_3_2","C2_2");
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_3_2);

        String noonGiftPart1 ="“The same as you two. I woke up in the night to a man looking at me. Then I fell back asleep,” you reply.\n" +
                "“So we all saw the same things,” David says. “I think there may be something magical going on, but I’m not sure.”\n" +
                "“Cultists, probably,” Hilda says. “Bastards have probably been coming here to kill us in the name of Sarash. Archia be blessed for our lives,” she says.\n" +
                "“You know how I feel about saying the demon’s name, but I think you’re right, Archia be praised,” David says. “In any case, we have to decide how to get back to town. I don’t really think they are going the right way, but it may be better to stay together regardless.”\n";
