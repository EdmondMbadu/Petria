...
public class C2_23_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_23_2);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_23_2",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_23_2);

        String text ="“I better get a little closer,” you think.\n" +
                "\tYou begin to take a step, but something pulls on your ear.\n" +
                "\t“Do as you’re fucking told,” Mo whispers.\n" +
                "\tAs Mo speaks, Meytheo appears out of the chard tree and strikes the man on the head with her club. The man falls into the fire. \n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_1= findViewById(R.id.button_C24_1);
