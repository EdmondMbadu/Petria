...
public class C2_24_13 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_13);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_13", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_13);
        ...
        String text = "“Reshga Kakaw”\n" +
                ...
                "Meytheo slams her club into a jackal’s chest. It spits up blood and snarls, biting into her arm. The bear comes behind it and takes the back of its neck into the bear’s mouth. The bear bites down, and the jackal’s body becomes limp. The other jackal tries to flee, but Meytheo strikes its knees with her club and the bear descends on it until it ceases to move.\n";
