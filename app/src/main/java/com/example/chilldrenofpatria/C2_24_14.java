...
public class C2_24_14 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_14);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_14", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_14);

        String text ="“Dole Kakaw”\n" +
                "The blue bolt bludgeons the shoulder of the jackal attacking the wolf. Meytheo raises her club and swings it down, splitting the jackal’s head. The other jackal tries to run, but the bear swipes its legs, and it falls to its knees. It stands to its feet just as the wolf bites into its arm, and the bear rises up and bites into the back of its neck. With a crunch, the jackal’s body falls limp and topples to the ground.\n" +
        ...
        switch (view.getId()) {
            ...
            case R.id.button_C24_23:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_14", dbHandler.getBeforeLast2(1));
