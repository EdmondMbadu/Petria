...
public class C2_7_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_7_1);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_7_1",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_7_1);

        String text ="After the conversation with the sheriff, your family is allowed to sleep in the local church dedicated to Elivine. The sleeping was fitful, but the hay was soft and you felt safe. Sheriff Tom put you and a messenger on a wagon in the morning and you made your way back to Blackborough by about mid-day. The messenger went straight to the town hall, but you, David, and Hilda made your way back to the bakery.\n" +
                "\t“Shit! There’s a mess in there,” you think. “I forgot about the fight entirely.”\n" +
