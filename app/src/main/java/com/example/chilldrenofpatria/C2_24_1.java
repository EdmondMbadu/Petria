...
public class C2_24_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_1);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_24_1",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_1);

        String text ="The creatures screech, five of them descending on Meytheo. The other two become jackals and bolt towards the woods. Vines sprout from the ground all around the fleeing jackals, twisting around their legs and bodies and stopping them in their tracks. The bear and the wolf run to help Meytheo.\n" +
                "“Shit,” you think. “What do I do?”\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2= findViewById(R.id.button_C24_2);
        Button butonC24_3= findViewById(R.id.button_C24_3);
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.button_C24_2:
                intent= new Intent(this, C2_24_2.class);
                startActivity(intent);
                break;
            case R.id.button_C24_3:
                intent= new Intent(this, C2_24_3.class);
                startActivity(intent);
                break;
