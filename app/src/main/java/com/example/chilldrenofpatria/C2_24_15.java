...
public class C2_24_15 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_15);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_15", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_15);

        String text = "“Reshga Kakaw”\n" +
                "The trees shine like blue pillars as you speak the words. The blue mass launches from your staff, striking the jackal who attacked the wolf. The jackal tumbles across the forest floor, striking a tree. It struggles to rise to its feet, but the wolf jumps onto it, ripping its teeth into the jackal’s neck.\n" +
                "The other jackal tries to run, but the bear swipes its legs, and it falls to its knees. It stands to its feet just as Meytheo raises her club and swings it down on its back. You hear a popping sound, and it screams. The bear comes behind it, biting the back of its neck with a crunch; the jackal stops moving. \n" +
                "As you see it die, you look around you and see a jackal running toward you.\n" +
                "“Shit!” you think.\n";
