...
public class C2_14_6 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_14_6);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_14_6",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_14_6);

        String text ="“Hot springs? What is a hot spring?” you ask.\n" +
                "\t“I forget myself. You all don’t even know that the hot springs are here. I don’t really know why you would, either. They are very well hidden and very hard to get to,” Mo says. “Hot springs are places where hot water comes from the ground, just like normal springs but hot. They make pools of water that always stay warm year round.”\n";
