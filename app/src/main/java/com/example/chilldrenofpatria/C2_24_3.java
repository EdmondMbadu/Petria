...
public class C2_24_3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_3);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_3", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_3);

        String text ="Shifting your focus to Meytheo, you see the werejackals bite at her chest and neck. Their teeth drag against her body but do not break her skin. The bear swipes at a werejackal’s back. The jackal yelps as the bear’s claws sink into its bloody fur, and it cries as the bear bites down on the werejackal’s arm. The wolf bites at another werejackal’s leg, sinking in its long teeth.\n" +
                "“There are three of them still on Meytheo!” you think.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_6);
        Button butonC24_3 = findViewById(R.id.button_C24_7);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_C24_6:
                intent = new Intent(this, C2_24_6.class);
                startActivity(intent);
                break;
            case R.id.button_C24_7:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_3", dbHandler.getBeforeLast2(1));
