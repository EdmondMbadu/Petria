...
public class C2_24_10 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_10);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_10", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_10);

        String text = "“I’ll let the lion kill it,” you think. “I don’t want it pouncing the same time I cast a spell.”\n" +
                "You watch the jackal closely, but just as it escapes the vines and begins to run, the lion pounces, digging its claws and then teeth into the jackal’s neck.\n";
