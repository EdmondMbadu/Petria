...
public class C2_9_4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_9_4);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_9_4",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_9_4);

        String text ="“As much as I would love to cast a few spells, it’s best to stay safe until Noone comes back,” you think. “I’ll just do my best to fall asleep.”\n" +
                "\tFeeling disappointed, you spend much of the night trying to fall asleep, reciting spells in your mind often, holding the little book to your chest. Eventually though, you find rest.\n";
