...
public class C2_14_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_14_2);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_14_2",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_14_2);

        String text ="“Who are you? I mean, besides just your name,” you ask.\n" +
                "\t“Me? I’m hardly the most interesting person to be asking about,” Mo says. “I’m a fairy who’s been helping Noone. She’s got a lot of us working for her. She’s saved a few fairy villages here and there, and she’s been very good to us who work for her. It’s actually very rare that fey help anyone who doesn’t serve or descend from Voya.”\n";
...
//        textViewScroll.setText(formattedText);
        ...
        Button butonC14_7= findViewById(R.id.button_C14_7);


        butonC14_3.setOnClickListener(this);
        butonC14_7.setOnClickListener(this);
