...
public class C2_18_4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_18_4);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_18_4",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_18_4);

        String text ="“Uhh… Both?” you say.\n" +
                "\t“We can’t kill all of them by ourselves, so Theo has gathered a group to help us. We are going to have to make sure they are all dead. They won’t stop causing trouble otherwise.”\n" +
                "\t“Oh.”\n";
