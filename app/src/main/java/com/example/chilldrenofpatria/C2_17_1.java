...
public class C2_17_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_17_1);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_17_1",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_17_1);

        String text ="“Mo, what does she mean by ‘extermination crew’?” you ask.\n" +
                "\t“Which part is confusing, the crew part or the extermination part?” Mo replies.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC18_1= findViewById(R.id.button_C18_1);
        Button butonC18_2= findViewById(R.id.button_C18_2);
        Button butonC18_3= findViewById(R.id.button_C18_3);

        butonC18_1.setOnClickListener(this);
        butonC18_2.setOnClickListener(this);
        butonC18_3.setOnClickListener(this);
