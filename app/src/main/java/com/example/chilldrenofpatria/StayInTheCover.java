...
public class StayInTheCover extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String text="“It would be better to be less noticeable I don’t want anything finding me out here,” you think. The deeper you wander into the woods the more nervous you get. Your feeling shifts to anticipation when you hear the beating of drums. This distracts you from the lights, and all five disappear. Once gone though, you can clearly make out the light of a fire. Noone’s light vanishes too.\n" +
