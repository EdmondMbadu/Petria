...
public class C2_3_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_3_1);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_3_1","C2_2");
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_3_1);

        String noonGiftPart1 ="“I went to bed last night and woke up here. That’s all I remember,” you reply.\n" +
                "David thinks for a few moments.\n" +
                "“Maybe they hit you hard enough to make you lose your memory. Maybe that’s what happened to all of us,” David says. “In any case, we have to decide how to get back to town. I don’t really think they are going the right way, but it may be better to stay together regardless.”\n";
