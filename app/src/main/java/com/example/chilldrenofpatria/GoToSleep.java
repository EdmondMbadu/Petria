...
public class GoToSleep extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler.updateChapter(1,dbHandler.getHealth(1),dbHandler.getSpell(1),"GoToSleep","DoleKakawContinue");
            ...
            case R.id.button_CastASpell:
                ...
                forceStrike.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        dbHandler.updateChapter(1,dbHandler.getHealth(1),dbHandler.getSpell(1)-1,"GoToSleep","DoleKakawContinue");
...
//                }, 2000);   //2 seconds or 2000 mili seconds
                pleaseLeave.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
