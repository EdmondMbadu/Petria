...
public class C2_24_12 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_12);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_12", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_12);

        String text = "“Dole Kakaw”\n" +
                "The bolt flies from your staff, bludgeoning the shoulder of the werejackal attacking Meytheo. Meytheo smashes the jackal’s hip with her club, and it staggers back. The bear bites into its neck and jerks, blood splattering from the jackal as it falls to the ground. Turning, the bear swipes at the jackal attacking the wolf but misses. The other jackal attempts to flee. The wolf bites its leg, and Meytheo strikes its shoulder as it does.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_19);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_C24_19:
                intent = new Intent(this, C2_24_19.class);
                startActivity(intent);
                break;
            case R.id.button_C24_20:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_12",  dbHandler.getBeforeLast2(1));
