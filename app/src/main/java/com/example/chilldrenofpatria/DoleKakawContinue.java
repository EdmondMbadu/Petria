...
public class DoleKakawContinue extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(dbHandler.getLastClass(1).equalsIgnoreCase("DoleKakaw")) {
            dbHandler.updateChapter(1,dbHandler.getHealth(1),dbHandler.getSpell(1),"DoleKakawContinue","DoleKakaw");
        }
        else if(dbHandler.getLastClass(1).equalsIgnoreCase("KillSomeone")) {
            dbHandler.updateChapter(1,dbHandler.getHealth(1),dbHandler.getSpell(1),"DoleKakawContinue","KillSomeone");
        }
        else {
            dbHandler.updateChapter(1,7,2,"DoleKakawContinue",dbHandler.getLastClass(1));
