...
public class C2_9_3 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_9_3);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_9_3",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_9_3);

        String text ="“Hmm, force bolt will probably make some noise,” you think. “I’ll shoot it at my pillow.”\n" +
                "\tYou get out of bed and look at your pillow.\n" +
                "\t“Dole Kakaw.”\n" +
                "\tThe blue bolt streak shoots from your mouth, illuminating your room. It hits your pillow and shakes your bed.\n" +
                "\t“Shit,” you mutter.\n" +
                "\tYou go to lay back down in bed. The sheet of your pillow is torn, but the pillow itself isn’t ripped open.\n" +
                "\t“It glows in the dark,” you think. “How didn’t I realize that before?”\n" +
                "\tDeciding you’ve made enough noise for night, you close your eyes, eventually falling to sleep.\n";
