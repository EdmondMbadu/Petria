...
public class C2_18_5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_18_5);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_18_5",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_18_5);

        String text ="“If they don’t spend time with people, who do they spend time with?” you ask.\n" +
                "\t“Your definition of ‘people’ may need to change, kid. You’ve only ever dealt with other humans, and the occasional elf or traveling gnome. The world is much bigger than that,” Mo replies.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC19_1= findViewById(R.id.button_C19_1);

        butonC19_1.setOnClickListener(this);
