...
public class C2_24_16 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_16);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_16", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_16);

        String text ="You hear a twig snap. Your eyes flash to the sound, and you find a werejackal charging right in front of you.\n";

        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_24);
        Button butonC24_3 = findViewById(R.id.button_C24_25);
        ...
        switch (view.getId()) {
            case R.id.button_C24_24:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_16", dbHandler.getBeforeLast2(1));

                    intent = new Intent(this, C2_24_24.class);
                    startActivity(intent);
                }
                break;
            case R.id.button_C24_25:
                if (dbHandler.getHealth2(1) <= 0) {

                    Toast.makeText(this, "You do not have enough health!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, "You have lost 5 health points!", Toast.LENGTH_SHORT).show();
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1)-5, dbHandler.getSpell2(1) , "C2_24_16", dbHandler.getBeforeLast2(1));
