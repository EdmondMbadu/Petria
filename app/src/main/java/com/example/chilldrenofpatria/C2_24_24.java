...
public class C2_24_24 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_24);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_24", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_24);

        String text ="“Cha”\n" +
                "A prism of blue surrounds you. The jackal bites at you, but the blue prismatic shield pushes it away. It continues running but doesn’t make it far. Meytheo appears from one of the trees and smashes its chest with her club. It drops to its knees, spitting up blood, just as she takes another swing, and its head flies back with a snap. \n" +
                "Looking around to check there isn’t any more, you find the wolf laying dead next to the fire place. You look at Meytheo, who is dragging the jackal to the fire pit. She throws it on the fire and walks to the next body.\n" +
