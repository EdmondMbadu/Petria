...
public class C2_14_8 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_14_8);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_14_8",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_14_8);

        String text ="“Who is Petria?” you ask.\n" +
                "\t“I forget myself. You’ve lived a sheltered life in comparison to me. Petria is a goddess. You should ask Noone about her when you can. She is quite interesting,” Mo replies.\n";
