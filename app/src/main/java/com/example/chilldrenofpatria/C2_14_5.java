...
public class C2_14_5 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_14_5);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_14_5",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_14_5);

        String text ="\t“Who is Chagama?” you ask.\n" +
                "\t“He is warlock of Hashi. A green dragonborn who has been leading a group of lizardfolk north. Don’t worry about any of that for now. We will discuss all of that very soon,” Mo replies.\n";
