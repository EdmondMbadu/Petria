...
public class C2_24_8 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_8);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_8", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_8);

        String text = "“Dole Kakaw”\n" +
                "The alien blue light streaks from your staff, flickering out as it bludgeons the jackal’s hip. Yelping, it gets free of its binds and runs. \n" +
                "It does not escape, as the lion leaps on it from behind. It falls to the ground, and the lion’s teeth sink into its neck. It thrashes for a moment before falling limp as the lion twists its neck.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_16);
