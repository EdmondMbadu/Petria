...
public class C2_24_7 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_7);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_7", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_7);

        String text ="“Rashga Kakaw”\n" +
                "For a moment blue light outshines the fire. The shrieking energy shakes the air as it passes, striking the werejackal attacked by the wolf. It tumbles across the forest floor, its arms and legs twisting as it rolls. \n" +
                "Meytheo strikes one on the side of its face with her club. It falls to the ground. Another at her arm sinks its teeth in her rough skin. The bear tears into the jackal its facing, ripping it open with its claws and teeth. With a whimper, the wolf is bitten by another werejackal. \n" +
                "“Two left,” you think.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_14);
        Button butonC24_3 = findViewById(R.id.button_C24_15);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_C24_14:
                intent = new Intent(this, C2_24_14.class);
                startActivity(intent);
                break;
            case R.id.button_C24_15:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_7",  dbHandler.getBeforeLast2(1));
