...
public class C2_18_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_18_2);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_18_2",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_18_2);

        String text ="“The extermination part,” you say.\n" +
                "\t“They don’t belong here they are causing all kinds of trouble. We are going to have to kill them or they will keep causing trouble,” Mo says.\n" +
                "\t“Oh.”\n";
