...
public class C2_23_1 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_23_1);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_23_1",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_23_1);

        String text ="“It’s best if I stay put as Meytheo told me,” you think.\n" +
                "\tAs you decide, Meytheo appears out of the chard tree and strikes the man on the back of the head with her club. The man falls into the fire.\n";
