...
public class C2_24_4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_4);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_4", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_4);

        String text ="“Dole Kakaw”\n" +
                "The blue bolt of force leaps from the crystal in your staff. In flash of light, it strikes the entrapped jackal in the shoulder. It buckles, its front leg mangled from the impact.\n" +
                "The lion bites its jackal’s neck. The jackal twists and kicks, then falls limp to the ground.\n" +
                "The jackal you attacked still struggles to free itself, chewing at the vines entrapping it.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_8);
        Button butonC24_3 = findViewById(R.id.button_C24_9);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_C24_8:
                intent = new Intent(this, C2_24_8.class);
                startActivity(intent);
                break;
            case R.id.button_C24_9:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_4",  dbHandler.getBeforeLast2(1));
