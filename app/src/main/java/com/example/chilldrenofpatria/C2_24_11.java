...
public class C2_24_11 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_11);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_11", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_11);

        String text = "“Dole Kakaw”\n" +
                "The beam leaps to the jackal, striking its head. It drops to the ground, the vines still spun around its lifeless body. \n" +
                "The lion turns, looking at you.\n";
