...
public class KillSomeone extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler.updateChapter(1,dbHandler.getHealth(1),dbHandler.getSpell(1),"DoleKakaw","YesIDoContinue");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_kill_someone);
        ...
        TextView textView = (TextView) findViewById(R.id.text_scrollKillSomeone);
        ...
        Button buttonKillSomeoneContinue= findViewById(R.id.button_KillSomeoneContinue);


        buttonKillSomeoneContinue.setOnClickListener(this);
    }
