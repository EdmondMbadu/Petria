...
public class C2_24_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_2);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_2", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_2);

        String text = "Your focus shifts to the ensnared jackals. The mountain lion leaps from the darkness striking one with its claw, knocking it further into the tangled mess. The jackal whimpers as the lion bites at its neck. \n" +
                "The other jackal struggles to get free, biting at the vines entrapping it.\n" +
                "“That one,” you think.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC24_2 = findViewById(R.id.button_C24_4);
        Button butonC24_3 = findViewById(R.id.button_C24_5);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.button_C24_4:
                intent = new Intent(this, C2_24_4.class);
                startActivity(intent);
                break;
            case R.id.button_C24_5:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_2", dbHandler.getBeforeLast2(1));
