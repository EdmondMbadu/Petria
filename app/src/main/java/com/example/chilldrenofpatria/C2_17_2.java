...
public class C2_17_2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_17_2);
        dbHandler= new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1,dbHandler.getHealth2(1),dbHandler.getSpell2(1),"C2_17_2",dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_17_2);

        String text ="“Mo, do all Dryads walk around without clothing?” you ask.\n" +
                "\t“Pretty much. They’re complicated beings dryads. They only come in the female variety and don’t make it a habit of spending too much time with other humanoids, especially humans, so they don’t really need clothes for any social reasons,” Mo replies.\n";
        textViewScroll.setText(Format(text), TextView.BufferType.SPANNABLE);

//        textViewScroll.setText(formattedText);

        Button butonC18_4= findViewById(R.id.button_C18_4);
        Button butonC18_5= findViewById(R.id.button_C18_5);


        butonC18_4.setOnClickListener(this);
        butonC18_5.setOnClickListener(this);
    ...
    public void onClick(View view) {
        ...
        switch(view.getId()){
            case R.id.button_C18_4:
                intent= new Intent(this, C2_18_4.class);
                startActivity(intent);
                break;
            case R.id.button_C18_5:
