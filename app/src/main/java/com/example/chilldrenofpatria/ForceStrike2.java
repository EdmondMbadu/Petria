...
public class ForceStrike2 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler.updateChapter(1, dbHandler.getHealth(1), dbHandler.getSpell(1), "ForceStrike2", "ForceBotCantrip");

        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_force_strike2);
        ...
        TextView textView = (TextView) findViewById(R.id.text_scrollForceStrike2);
        String text="“Reshga Kakaw.”\n" +
                "\tBlue light flashes around you, a spire of energy strikes the man’s torso. He flies back slamming against the wall behind him, his sword clanging to the floor. Blood streams from his stomach. For a while, you watch his unmoving body. Eventually you’re convinced he’s dead.\n";
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.goback:
                intent= new Intent(this, Book1Activity.class).putExtra("from", "ForceStrike2");
