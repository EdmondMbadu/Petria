...
public class ForceStrike202 extends AppCompatActivity  implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHandler.updateChapter(1, dbHandler.getHealth(1), dbHandler.getSpell(1),"ForceStrike202","CastDancingLightsContinue");
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.button_ForceStrike202End:
                ...
                intent= new Intent(this, Book1Activity.class);
                dbHandler.deleteChapterContent(); dbHandler.deleteChapterContent();
                dbHandler.addChapter(5, 2, "MainActivity", "");
