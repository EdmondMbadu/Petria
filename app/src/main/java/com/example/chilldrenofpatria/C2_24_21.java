...
public class C2_24_21 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_c2_24_21);
        dbHandler = new DBHandler(this, null);
        //update the database with another s
        dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1), "C2_24_21", dbHandler.getLastClass2(1));
...
//        Initialize the toolbar
        ...
        TextView textViewScroll = (TextView) findViewById(R.id.text_scrollC2_24_21);
...
//        textViewScroll.setText(formattedText);
        ...
        Button butonC24_2 = findViewById(R.id.button_C24_26);
        Button butonC24_3 = findViewById(R.id.button_C24_27);
        ...
        switch (view.getId()) {
            case R.id.button_C24_26:
                if (dbHandler.getSpell2(1) <= 0) {
                    ...
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1), dbHandler.getSpell2(1) - 1, "C2_24_26", dbHandler.getBeforeLast2(1));

                    intent = new Intent(this, C2_24_26.class);
                    startActivity(intent);
                }
                break;
            case R.id.button_C24_27:
                if (dbHandler.getHealth2(1) <= 0) {

                    Toast.makeText(this, "You do not have enough spell slot!", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(this, "You have lost 1 spell slot!", Toast.LENGTH_SHORT).show();
                    dbHandler.updateChapter2(1, dbHandler.getHealth2(1)-5, dbHandler.getSpell2(1) , "C2_24_21", dbHandler.getBeforeLast2(1));
